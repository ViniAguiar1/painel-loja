                                    ...
                                    <div className="dropdown-header d-flex align-items-center justify-content-between">
                                        ...
                                        <ul className="list-inline ms-auto mb-0">
                                            <li className="list-inline-item">
                                                <Link to="#" className="avtar avtar-s btn-link-hover-primary">
                                            ...
                                            <ul className="list-group list-group-flush w-100">
                                                <li className="list-group-item">
                                                    <div className="d-flex align-items-center">
                                                        <div className="flex-shrink-0">
                                                            <img src={avatar1} alt="user-image" width={50} className="wid-50 rounded-circle" />
                                                        </div>
                                                ...
                                                <li className="list-group-item">
                                                    ...
                                                    <Dropdown.Item>
                                                        <span className="d-flex align-items-center"  onClick={handleLogout} >
                                                            <i className="ph-duotone ph-power"></i>
                                                            <span>Logout</span>
                                                        </span>
                                                    </Dropdown.Item>
